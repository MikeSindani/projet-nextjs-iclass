...
const SectionsAvantages = () => {
  return (
    <section
      id="avantages"
      className="flex flex-col bg-white justify-center items-start space-x-3 px-4 py-10 md:px-16  w-full"
    >
      ...
      <div className="flex flex-col-reverse md:flex-row justify-center items-start space-x-3">
        <div className="flex max-md:flex-col  w-full md:w-1/2 gap-3 md:p-6">
          ...
          <ScrollAnimation animateIn="fadeIn"  className="md:w-2/3">
            <h2 className="font-bold text-left text-xl md:text-2xl m-2 flex items-center">
            <Image
              src={ImageTick}
              alt="tick"
